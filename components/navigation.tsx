...
export function Navigation() {
  ...
  return (
    // ...existing code...
<header className="pt-[1rem] absolute top-0 left-0 w-full z-50 bg-transparent">
  <div className="container flex h-16 items-center justify-between px-4 max-content-width">
    ...
    <nav className="hidden md:flex items-center space-x-8">
      <Link href="/" className="text-sm font-light hover:text-gray-600 transition-colors text-white">
        Home
      </Link>
      <Link href="/products" className="text-sm font-light hover:text-gray-600 transition-colors text-white">
        Products
      </Link>
    ...
    <div className="flex items-center space-x-2">
      {/* Use SVG icons for white and white style */}
      {/* <Button variant="ghost" size="icon" className="hidden sm:flex text-white hover:text-gray-600">
      ...
      <Button variant="ghost" size="icon" className="text-white hover:text-gray-600">
        <svg width="20" height="20" fill="none" stroke="white" strokeWidth="1.5" viewBox="0 0 24 24">
          <circle cx="12" cy="8" r="4" stroke="white" />
          <path d="M4 20c0-4 8-4 8-4s8 0 8 4" stroke="white" />
        </svg>
      </Button> */}

      <CartDrawer>
        <Button variant="ghost" size="icon" className="text-white hover:text-gray-600 relative">
          <svg width="20" height="20" fill="none" stroke="white" strokeWidth="1.5" viewBox="0 0 24 24">
            <circle cx="9" cy="21" r="1" stroke="white" />
            <circle cx="20" cy="21" r="1" stroke="white" />
            <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" stroke="white" />
          </svg>
          {totalItems > 0 && (
            <span className="absolute -top-1 -right-1 bg-white text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
              {totalItems}
            </span>
          )}
        </Button>
      ...
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetTrigger asChild>
          <Button variant="ghost" size="icon" className="md:hidden text-white hover:text-gray-600">
